        ...
        <div className="text-sm items-start box-border caret-transparent gap-x-10 flex leading-5 outline-[3px] gap-y-10 md:text-base md:leading-6">
          <div className="text-sm box-border caret-transparent flex flex-col leading-5 min-h-[auto] min-w-[auto] outline-[3px] w-full md:text-base md:leading-6">
            <div className="text-sm items-center box-border caret-transparent gap-x-4 flex justify-between leading-5 min-h-[auto] min-w-[auto] outline-[3px] gap-y-4 md:text-base md:leading-6">
              ...
              <div className="text-sm items-center box-border caret-transparent gap-x-2 flex leading-5 min-h-[auto] min-w-[auto] outline-[3px] w-full md:text-base md:leading-6">
                <img
                  src="https://futabus.vn/images/icons/pickup.svg"
                  alt="pickup"
                  className="text-sm box-border caret-transparent leading-5 max-w-full min-h-[auto] min-w-[auto] outline-[3px] md:text-base md:leading-6 shrink-0"
                />
                ...
                <span className="text-gray-500 text-sm box-border caret-transparent block leading-4 min-h-[auto] min-w-[auto] outline-[3px] text-center md:text-base shrink-0">
            ...
            <div className="text-[13px] box-border caret-transparent flex justify-between items-center leading-5 min-h-[auto] min-w-[auto] outline-[3px] mt-3 md:leading-6">
              ...
              <div className="box-border caret-transparent basis-[0%] grow leading-5 min-h-[auto] min-w-[auto] outline-[3px] text-right md:leading-6 flex items-center gap-2">
                <span className="text-[15px] font-medium box-border caret-transparent leading-5 outline-[3px] md:leading-6">
                  {trip.dropoffStation}
                </span>
                <br className="box-border caret-transparent leading-5 outline-[3px] md:leading-6" />
                <span className="text-gray-500 box-border caret-transparent leading-5 outline-[3px] mt-2 md:leading-6"></span>
                <span className="text-orange-600 text-lg font-semibold box-border caret-transparent leading-7 outline-[3px] ml-2 md:min-h-[auto] md:min-w-[auto]">
                  {trip.price.toLocaleString('vi-VN')}đ
                </span>
              </div>
            </div>
          </div>
          <div className="text-gray-500 text-sm items-center box-border caret-transparent gap-x-1 hidden flex flex-nowrap leading-5 min-h-0 outline-[3px] md:text-base md:flex md:leading-6 md:min-h-[auto]">
            <div className="text-sm bg-neutral-300 box-border caret-transparent h-1.5 leading-5 min-h-0 min-w-0 outline-[3px] w-1.5 rounded-full md:text-base md:leading-6 md:min-h-[auto] md:min-w-[auto] shrink-0"></div>
            <span className="text-sm box-border caret-transparent leading-5 min-h-0 min-w-0 outline-[3px] md:text-base md:leading-6 md:min-h-[auto] md:min-w-[auto] shrink-0 whitespace-nowrap">
              {trip.busType}
            </span>
            <div className="text-sm bg-neutral-300 box-border caret-transparent h-1.5 leading-5 min-h-0 min-w-0 outline-[3px] w-1.5 rounded-full md:text-base md:leading-6 md:min-h-[auto] md:min-w-[auto] shrink-0"></div>
            <span className="text-emerald-800 text-sm box-border caret-transparent leading-5 min-h-0 min-w-0 outline-[3px] md:text-base md:leading-6 md:min-h-[auto] md:min-w-[auto] shrink-0 whitespace-nowrap">
