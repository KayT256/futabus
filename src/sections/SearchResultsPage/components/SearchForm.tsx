  ...
  return (
    <div className="text-sm font-medium bg-white box-border caret-transparent leading-5 max-w-[1128px] outline-orange-800/10 outline outline-8 w-auto border border-orange-600/60 m-2 pt-3 pb-6 px-4 rounded-2xl border-solid md:text-base md:leading-6 md:w-[1128px] md:m-auto md:pt-6 md:px-6">
      <div className="text-[15px] items-center box-border caret-transparent flex justify-between leading-5 outline-[3px] md:leading-6">
        <div className="text-black/90 text-[0px] box-border caret-transparent leading-[0px] list-none min-h-0 min-w-0 outline-[3px] md:min-h-[auto] md:min-w-[auto]">
          <label className="relative text-orange-600 text-[15px] items-baseline box-border caret-transparent inline-flex leading-[23.5725px] outline-[3px] mr-5 after:accent-auto after:box-border after:caret-transparent after:text-orange-600 after:block after:text-[15px] after:not-italic after:tabular-nums after:font-medium after:tracking-[normal] after:leading-[23.5725px] after:list-outside after:list-none after:min-h-0 after:min-w-0 after:outline-[3px] after:pointer-events-auto after:text-start after:no-underline after:indent-[0px] after:normal-case after:visible after:w-0 after:overflow-hidden after:border-separate after:font-intertight after:md:min-h-[auto] after:md:min-w-[auto]">
            <span className="relative text-black/90 text-sm box-border caret-transparent block leading-[22.001px] min-h-0 min-w-0 outline-[3px] top-[2.8px] md:min-h-[auto] md:min-w-[auto]">
              <span className="relative bg-white box-border caret-transparent block h-4 outline-[3px] w-4 border border-orange-600 rounded-[50%] border-solid left-0 top-0 after:accent-auto after:bg-orange-600 after:box-border after:caret-transparent after:text-black/90 after:block after:text-sm after:not-italic after:tabular-nums after:font-medium after:h-4 after:tracking-[normal] after:leading-[22.001px] after:list-outside after:list-none after:outline-[3px] after:pointer-events-auto after:absolute after:text-start after:no-underline after:indent-[0px] after:normal-case after:transform-none after:visible after:w-4 after:-ml-2 after:-mt-2 after:rounded-2xl after:border-separate after:left-2/4 after:top-2/4 after:font-intertight after:md:scale-50"></span>
            </span>
            <span className="box-border caret-transparent block min-h-0 min-w-0 outline-[3px] px-2 md:min-h-[auto] md:min-w-[auto]">
              Một chiều
            </span>
          </label>
          <label className="relative text-[15px] font-normal items-baseline box-border caret-transparent inline-flex leading-[23.5725px] outline-[3px] mr-5 after:accent-auto after:box-border after:caret-transparent after:text-black/90 after:block after:text-[15px] after:not-italic after:tabular-nums after:font-normal after:tracking-[normal] after:leading-[23.5725px] after:list-outside after:list-none after:min-h-0 after:min-w-0 after:outline-[3px] after:pointer-events-auto after:text-start after:no-underline after:indent-[0px] after:normal-case after:visible after:w-0 after:overflow-hidden after:border-separate after:font-intertight after:md:min-h-[auto] after:md:min-w-[auto]">
            <span className="relative text-sm box-border caret-transparent block leading-[22.001px] min-h-0 min-w-0 outline-[3px] top-[2.8px] md:min-h-[auto] md:min-w-[auto]">
        ...
        <span className="text-orange-600 box-border caret-transparent hidden leading-5 outline-[3px] md:contents md:leading-6">
          <a
            ...
            className="box-border caret-transparent inline leading-5 min-h-0 min-w-0 outline-[3px] md:block md:leading-6 md:min-h-[auto] md:min-w-[auto]"
          >
            Hướng dẫn mua vé
          </a>
        </span>
      ...
      <div className="text-sm box-border caret-transparent gap-x-[normal] grid grid-cols-[repeat(1,minmax(0px,1fr))] leading-5 outline-[3px] gap-y-[normal] py-4 md:text-base md:gap-x-4 md:grid-cols-[repeat(2,minmax(0px,1fr))] md:leading-6 md:gap-y-4">
        <div className="relative text-sm box-border caret-transparent gap-x-[normal] flex justify-center leading-5 min-h-0 min-w-0 outline-[3px] gap-y-[normal] md:text-base md:gap-x-4 md:leading-6 md:min-h-[auto] md:min-w-[auto] md:gap-y-4">
          <div className="text-sm box-border caret-transparent basis-[0%] grow leading-5 min-h-0 min-w-0 outline-[3px] md:text-base md:leading-6 md:min-h-[auto] md:min-w-[auto]">
            ...
            <div className="text-base [align-items:normal] box-border caret-transparent flex h-14 leading-6 outline-[3px] w-full border-neutral-900 mt-1 p-0 rounded-lg border-0 border-none md:text-lg md:items-center md:h-[67px] md:leading-7 md:border md:border-zinc-200 md:px-5 md:py-3 md:border-solid">
              <span className="text-base box-border caret-transparent block leading-6 max-w-[140px] min-h-0 min-w-0 outline-[3px] text-ellipsis text-nowrap overflow-hidden md:text-lg md:leading-7 md:max-w-[220px] md:min-h-[auto] md:min-w-[auto]">
                TP. Hồ Chí Minh
          ...
          />
          <div className="text-sm box-border caret-transparent basis-[0%] grow leading-5 min-h-0 min-w-0 outline-[3px] text-right md:text-base md:leading-6 md:min-h-[auto] md:min-w-[auto] md:text-left">
            ...
            <div className="text-base [align-items:normal] box-border caret-transparent flex h-14 justify-end leading-6 outline-[3px] text-right w-full border-neutral-900 mt-1 p-0 rounded-lg border-0 border-none md:text-lg md:items-center md:h-[67px] md:justify-start md:leading-7 md:text-left md:border md:border-zinc-200 md:px-5 md:py-3 md:border-solid">
              <span className="text-base box-border caret-transparent block leading-6 max-w-[140px] min-h-0 min-w-0 outline-[3px] text-right text-ellipsis text-nowrap overflow-hidden md:text-lg md:leading-7 md:max-w-[220px] md:min-h-[auto] md:min-w-[auto] md:text-left">
                Bến xe Đà Lạt
        ...
        <div className="text-sm bg-black/10 box-border caret-transparent block h-[0.5px] leading-5 outline-[3px] w-full my-3 md:text-base md:hidden md:leading-6"></div>
        <div className="text-sm box-border caret-transparent flex leading-5 min-h-0 min-w-0 outline-[3px] md:text-base md:leading-6 md:min-h-[auto] md:min-w-[auto]">
          <div className="text-sm box-border caret-transparent flex basis-[0%] flex-col grow leading-5 min-h-0 min-w-0 outline-[3px] mr-4 md:text-base md:leading-6 md:min-h-[auto] md:min-w-[auto]">
            <label className="text-sm box-border caret-transparent block leading-5 min-h-0 min-w-0 outline-[3px] ml-0 md:leading-6 md:min-h-[auto] md:min-w-[auto] md:ml-5">
              Ngày đi
            </label>
            <div className="text-base [align-items:normal] box-border caret-transparent flex h-14 leading-6 min-h-0 min-w-0 outline-[3px] w-full border-neutral-900 mt-1 p-0 rounded-lg border-0 border-none md:text-lg md:items-center md:h-[67px] md:leading-7 md:min-h-[auto] md:min-w-[auto] md:border md:border-zinc-200 md:px-5 md:py-3 md:border-solid">
              <span className="text-base box-border caret-transparent block leading-6 max-w-[140px] min-h-0 min-w-0 outline-[3px] text-ellipsis text-nowrap overflow-hidden md:text-lg md:leading-7 md:max-w-[220px] md:min-h-[auto] md:min-w-[auto]">
                14/05/2026
          ...
          <div className="text-sm box-border caret-transparent flex basis-[0%] flex-col grow leading-5 min-h-0 min-w-0 outline-[3px] md:text-base md:leading-6 md:min-h-[auto] md:min-w-[auto]">
            <label className="text-sm box-border caret-transparent block leading-5 min-h-0 min-w-0 outline-[3px] ml-0 md:leading-6 md:min-h-[auto] md:min-w-[auto] md:ml-5">
              Số vé
            </label>
            ...
            <div className="text-sm items-center box-border caret-transparent flex justify-between leading-5 outline-[3px] w-14 mt-2 md:text-base md:hidden md:leading-6">
              <span className="text-sm box-border caret-transparent block leading-5 outline-[3px] md:text-base md:inline md:leading-6">
                1
              </span>
              <img
                alt=""
      ...
      <div className="text-sm box-border caret-transparent hidden leading-5 outline-[3px] md:text-base md:contents md:leading-6">
        <div className="text-sm box-border caret-transparent flex flex-col leading-5 outline-[3px] mb-6 md:text-base md:leading-6">
          ...
          <div className="text-sm box-border caret-transparent gap-x-6 flex leading-5 min-h-0 min-w-0 outline-[3px] gap-y-6 w-full overflow-auto pl-4 pb-1 md:text-base md:leading-6 md:min-h-[auto] md:min-w-[auto] md:pl-0">
            <div className="text-sm items-start bg-gray-50 box-border caret-transparent flex flex-col h-16 justify-start leading-5 min-h-0 min-w-0 outline-[3px] text-nowrap border border-zinc-200 pt-2 px-5 rounded-lg border-solid md:text-base md:leading-6 md:min-h-[auto] md:min-w-[auto]">
      ...
      <div className="relative text-sm box-border caret-transparent flex justify-center leading-5 outline-[3px] w-full md:text-base md:leading-6">
        <button className="absolute text-white text-base normal-nums bg-orange-600 caret-transparent block h-12 leading-6 outline-[3px] text-center z-10 px-20 py-0 rounded-full">
          Tìm chuyến xe
        </button>
      </div>
    </div>
